...
if (Yii::app()->utility->isActiveMenu('admin')) {
	$this->widget('zii.widgets.CMenu',array(
		...
		'items'=>array(
			...
			array('label'=>'<i class="fa fa-list-ul fa-lg fa-fw"></i> Misión y Visión', 'url'=>array('/option/strategydata'), 'active'=>Yii::app()->utility->isActiveSubMenu('strategydata'), 'visible'=>Yii::app()->user->checkAccess('admin, strategy_admin')),
