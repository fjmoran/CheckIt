...
--
-- Host: localhost
-- Generation Time: Jul 29, 2014 at 03:14 PM
...
INSERT INTO `kpi` VALUES(13, 'Rentabilidad por cliente', 'Rentabilidad por cliente', 1, 'cada 6 meses', '2014-06-02', '2015-06-02', 1500, 2500, 'USD', 3500, '2014-07-29 10:55:50', 1500, 2000, 2500, 2);
...
INSERT INTO `option` VALUES(9, 'manager_name', 'Encargado');
INSERT INTO `option` VALUES(10, 'managers_name', 'Encargados');
...
INSERT INTO `role` VALUES(1, 'admin', 'Administrador de sistema', 'Tiene acceso a todas las funcionalidades del sistema incluidas las de front y backend', 11, 'user/admin');
INSERT INTO `role` VALUES(2, 'strategy_admin', 'Administrador de gestión estratégica', 'Tiene acceso al backend para configurar perspectivas, objetivos estratégicos, hitos y KPI.', 7, 'project/admin');
INSERT INTO `role` VALUES(3, 'workflow_admin', 'Administrador de flujos de proceso', 'Tiene acceso al backend para configurar flujos de proceso y administrar grupos.', 8, 'process/admin');
INSERT INTO `role` VALUES(4, 'dashboard_admin', 'Administrador de cuadros de mando', 'Tiene acceso al backend para definir los grupos que pueden visualizar cada reporte o cuadro de mando, y configurar los reportes de sistema.', 9, '');
INSERT INTO `role` VALUES(5, 'strategy_manager', 'Encargado gestión estratégica', 'Tiene acceso al frontend de gestión estratégica, puede ver todas las perspectivas, Objetivos estratégicos, Hitos, Sub hitos, KPI y sub KPI y editar su contenido para todo su nivel jerárquico.', 4, 'project/myprojects');
INSERT INTO `role` VALUES(6, 'strategy_user', 'Usuario gestión estratégica', 'Tiene acceso al frontend de gestión estratégica, puede ver las Perspectivas y Objetivos donde posea Hitos, Sub hitos, KPI y sub KPI y puede modificarlos (solo puede modificar los que tiene asignados).', 1, 'project/myprojects');
INSERT INTO `role` VALUES(7, 'workflow_manager', 'Encargado flujos de proceso', 'Tiene acceso al frontend de flujos de proceso puede ver y reasignar todas las instancias de los flujos en ejecución, puede iniciar los flujos a los cuales pertenece y puede gestionar su inbox.', 5, '');
INSERT INTO `role` VALUES(8, 'workflow_user', 'Usuario flujos de proceso', 'Tiene acceso al frontend de flujos de proceso, puede iniciar los flujos a los cuales pertenece y puede gestionar su inbox.', 2, '');
INSERT INTO `role` VALUES(9, 'dashboard_manager', 'Encargado cuadros de mando', 'Tiene acceso al frontend de cuadros de mando puede visualizar todos los cuadros definidos con toda su información independiente de su nivel jerárquico.', 6, 'site/report');
INSERT INTO `role` VALUES(10, 'dashboard_user', 'Usuario cuadros de mando', 'Tiene acceso al frontend de cuadros de mando y puede visualizar los cuadros que le han sido asignados, la información a visualizar depende de su nivel jerárquico.', 3, 'site/report');
INSERT INTO `role` VALUES(11, 'viewer', 'Visualizador global', 'Tiene acceso al frontend de gestión estratégica, flujos de trabajo y cuadros de mando puede visualizar toda la información pero no puede modificarla. Puede gestionar su inbox e iniciar los flujos a los cuales pertenece', 10, 'site/report');
INSERT INTO `role` VALUES(12, 'system_admin', 'Administrador de usuarios', 'Puede administrar usuarios, departamentos y grupos.', 12, 'user/admin');
...
INSERT INTO `user` VALUES(6, 'fjmoran@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'Francisco José', 'Morán', 1, 'Gerente de Operaciones', '2014-05-08 13:34:24', '2014-07-29 15:10:43', NULL, NULL, 8, 1);
