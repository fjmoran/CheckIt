...
--
-- Host: localhost
-- Generation Time: Aug 06, 2014 at 03:26 PM
...
INSERT INTO `department` VALUES(4, NULL, 1, 21, 1, 'Dirección');
...
INSERT INTO `kpi` VALUES(9, 9, 1, 2, 1, 'Porcentaje de Satisfacción del cliente', 'Porcentaje de Satisfacción del cliente', 4, '2014-06-02', '2015-04-15', 60, 80, '%', 3, NULL, 4, 5, 1, 0, 0, '2014-06-30');
INSERT INTO `kpi` VALUES(10, 10, 1, 2, 1, 'Tasa de referidos', 'Tasa de referidos', 4, '2014-06-02', '2015-06-02', 1300, 2500, 'personas', 3, NULL, 5, 5, 1, 0, 0, '2014-12-31');
INSERT INTO `kpi` VALUES(11, 11, 1, 4, 1, 'Errores por millon', '# de errores / # total de productos', 5, '2014-06-02', '2015-06-02', 12, 24, 'unidades por millon', 8, NULL, 2, 5, 1, 0, 0, '2015-02-28');
INSERT INTO `kpi` VALUES(12, 12, 1, 2, 1, 'Porcentaje de entrega a tiempo', 'Porcentaje de entrega a tiempo', 5, '2014-06-02', '2015-06-02', 92, 98, '%', 8, NULL, 4, 5, 1, 0, 0, '2014-06-30');
INSERT INTO `kpi` VALUES(13, 13, 1, 2, 1, 'Rentabilidad por cliente', 'Rentabilidad por cliente', 1, '2014-06-02', '2015-06-02', 1500, 2500, 'USD', 2, NULL, 1, 2, 1, 0, 0, '2014-06-08');
INSERT INTO `kpi` VALUES(14, 14, 1, 2, 1, 'Crecimiento en ventas', 'Crecimiento en ventas', 3, '2014-06-02', '2015-06-02', 10, 25, '% anual', 2, NULL, 0, 0, 1, 0, 0, '2014-06-03');
INSERT INTO `kpi` VALUES(15, 15, 1, 2, 1, 'Cantidad de accidentes', 'Cantidad de accidentes/Tiempo', 5, '2014-06-02', '2015-06-02', 8, 20, 'accidentes por año', 9, NULL, 2, 5, 1, 0, 0, '2014-06-30');
INSERT INTO `kpi` VALUES(16, 16, 1, 2, 1, 'Obsolescencia de equipos informáticos ', 'Obsolescencia de equipos informáticos ', 7, '2014-06-02', '2015-06-02', 25, 35, '%', 9, NULL, 0, 0, 1, 0, 0, '2014-06-03');
INSERT INTO `kpi` VALUES(17, 11, 2, 3, 2, 'Sub errores por millón 2', 'errores/tiempo', 5, '2014-06-02', '2015-05-13', 10, 3, 'porcentaje', 12, NULL, 2, 5, 1.5, 1, 0, '2014-06-30');
INSERT INTO `kpi` VALUES(18, 18, 1, 6, 1, 'kpi de prueba', 'kpi', 7, '2014-08-01', '2014-08-29', 100, 200, 'kpi', 4, NULL, 1, 5, 1, 0, 0, '2014-08-03');
INSERT INTO `kpi` VALUES(19, 18, 3, 4, 3, 'kpi de prueba 2-', 'kljsdfkljsdf', 7, '2014-08-08', '2014-08-22', 1, 2, 'ssdf', NULL, 10, 3, 5, 1, 0, 0, '2014-09-30');
INSERT INTO `kpi` VALUES(20, 18, 2, 5, 2, 'kpi de prueba 3', 'sdlkfjsdlfkjsdf', 7, '2014-08-06', '2014-08-22', 2, 5, 'dfdksjhf', NULL, 22, 2, 5, 1, 0, 0, '2014-08-31');
...
INSERT INTO `kpi_data` VALUES(9, 11, 6, '2014-08-05 19:13:04', '2014-06-01', '2014-06-30', 14, NULL);
INSERT INTO `kpi_data` VALUES(10, 11, 6, '2014-08-05 19:16:53', '2014-07-01', '2014-07-31', 16, NULL);
INSERT INTO `kpi_data` VALUES(11, 11, 6, '2014-08-06 11:13:05', '2014-08-01', '2014-08-31', 18, NULL);
INSERT INTO `kpi_data` VALUES(12, 11, 6, '2014-08-06 11:13:52', '2014-09-01', '2014-09-30', NULL, NULL);
INSERT INTO `kpi_data` VALUES(13, 11, 6, '2014-08-06 11:17:12', '2014-10-01', '2014-10-31', 1.3, '');
INSERT INTO `kpi_data` VALUES(14, 11, 6, '2014-08-06 11:33:02', '2014-11-01', '2014-11-30', 123, NULL);
INSERT INTO `kpi_data` VALUES(15, 11, 6, '2014-08-06 13:34:31', '2014-12-01', '2014-12-31', 19, '');
INSERT INTO `kpi_data` VALUES(16, 11, 6, '2014-08-06 13:35:52', '2015-01-01', '2015-01-31', 23, 'Va en aumento en espera de alcanzar la meta');
...
INSERT INTO `option` VALUES(16, 'company_name', 'Enersis', 0);
...
INSERT INTO `task` VALUES(2, 2, 1, 2, 1, 'Definición de lugar planta distribución', 3, '2014-05-14', '2014-07-30', 1, '2014-05-17 00:00:00', 7, NULL);
...
INSERT INTO `task` VALUES(8, 8, 1, 2, 1, 'Curso de capacitación ISO-9001', 7, '2014-06-02', '2014-07-31', 0, NULL, NULL, 6);
...
INSERT INTO `user` VALUES(6, 'fjmoran@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'Francisco José', 'Morán', 1, 'Gerente de Operaciones', '2014-05-08 13:34:24', '2014-08-06 13:25:52', NULL, NULL, 8, 1);
...
ALTER TABLE `kpi_data`
  ADD CONSTRAINT `kpi_data_ibfk_1` FOREIGN KEY (`kpi_id`) REFERENCES `kpi` (`id`),
  ADD CONSTRAINT `kpi_data_ibfk_2` FOREIGN KEY (`user_id`) REFERENCES `user` (`id`);
