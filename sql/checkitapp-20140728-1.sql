...
--
-- Host: localhost
-- Generation Time: Jul 28, 2014 at 01:37 PM
...
INSERT INTO `department` VALUES(1, 'Gerente General', 4);
INSERT INTO `department` VALUES(2, 'Gerente Finanzas', 1);
INSERT INTO `department` VALUES(3, 'Gerente Marketing', 1);
INSERT INTO `department` VALUES(4, 'Director', NULL);
INSERT INTO `department` VALUES(7, 'Asesor Finanzas', 2);
INSERT INTO `department` VALUES(8, 'Gerente de Operaciones', 1);
INSERT INTO `department` VALUES(9, 'Gerente RR.HH.', 1);
INSERT INTO `department` VALUES(10, 'Asesor RR.HH.', 9);
INSERT INTO `department` VALUES(11, 'Asesor de Marketing', 3);
INSERT INTO `department` VALUES(12, 'Asesor de Operaciones', 8);
...
INSERT INTO `user` VALUES(5, 'christian.oviedo@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'Christian', 'Oviedo', 1, '2', '2014-05-08 13:34:24', '2014-07-28 13:09:31', NULL, NULL, NULL);
INSERT INTO `user` VALUES(6, 'fjmoran@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'Francisco José', 'Morán', 0, 'Gerente de Operaciones', '2014-05-08 13:34:24', '2014-06-27 14:15:46', NULL, NULL, 2);
INSERT INTO `user` VALUES(9, 'director1@check-it.cl', '21a70a20a394dc2a038843a51a64322b', 'Director 1', 'Empresa', 1, '4', '2014-05-12 10:12:35', '2014-06-17 03:28:29', NULL, NULL, NULL);
INSERT INTO `user` VALUES(10, 'director2@check-it.cl', 'c9c25d0280cad37aa512f2394f5baa34', 'Director 2', 'Empresa', 1, '4', '2014-05-12 10:12:45', NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES(18, 'gerente@check-it.cl', '740d9c49b11f3ada7b9112614a54be41', 'Gerente', 'General', 1, '1', '2014-05-30 15:43:02', '2014-06-17 03:28:08', NULL, NULL, NULL);
INSERT INTO `user` VALUES(19, 'finanzas@check-it.cl', 'd63d1f46dc616ff29efc6576bc19bc3d', 'Gerente', 'Finanzas', 1, '2', '2014-05-30 15:43:31', '2014-06-02 09:08:18', NULL, NULL, NULL);
INSERT INTO `user` VALUES(20, 'marketing@check-it.cl', 'c769c2bd15500dd906102d9be97fdceb', 'Gerente', 'Marketing', 1, '3', '2014-05-30 15:43:56', '2014-06-02 19:13:29', NULL, NULL, NULL);
INSERT INTO `user` VALUES(21, 'operaciones@check-it.cl', '527c128fd90c90859a5ca1617a2cd23d', 'Gerente', 'Operaciones', 1, '8', '2014-06-02 20:58:31', NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES(22, 'rrhh@check-it.cl', '89f71c4e9055ee73c3bc372528a54b9c', 'Gerente', 'RRHH', 1, '9', '2014-06-02 21:00:08', NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES(23, 'asesormarketing@check-it.cl', '6a20e01a1604491def7c3b3b9ae5454d', 'Asesor', 'Marketing', 1, '11', '2014-06-02 21:01:47', NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES(24, 'asesoroperaciones@check-it.cl', '482ef9d2cf35e966dfcaa8f4eaa76786', 'Asesor', 'Operaciones', 1, '12', '2014-06-02 21:08:51', NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES(25, 'asesorrrhh@check-it.cl', 'c4ac719461d9cacd6e75507afdd9c621', 'Asesor', 'RRHH', 1, '10', '2014-06-02 21:09:52', NULL, NULL, NULL, NULL);
INSERT INTO `user` VALUES(26, 'asesorfinanzas@check-it.cl', '4cd2440705e2ddbf9e9c044851c4f93c', 'Asesor', 'Finanzas', 1, '7', '2014-06-02 21:10:53', NULL, NULL, NULL, NULL);
