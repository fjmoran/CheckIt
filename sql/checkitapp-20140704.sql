...
--
-- Host: localhost
-- Generation Time: Jul 04, 2014 at 04:36 PM
...
INSERT INTO `form` VALUES(2, 'Formulario 2', 1);
...
INSERT INTO `process_connector` VALUES(80, 81, 82, 2, 1);
...
INSERT INTO `process_task` VALUES(81, 'Decisión', 2, 320, 160, 3);
INSERT INTO `process_task` VALUES(82, 'Actividad 1', 2, 580, 400, 0);
...
INSERT INTO `user` VALUES(5, 'christian.oviedo@gmail.com', '81dc9bdb52d04dc20036dbd8313ed055', 'Christian', 'Oviedo', 1, 2, '2014-05-08 13:34:24', '2014-07-04 13:37:41', NULL, NULL);
...
ALTER TABLE `form_field`
  ADD CONSTRAINT `form_field_ibfk_1` FOREIGN KEY (`form_id`) REFERENCES `form` (`id`);
